"""
Main transaction generator for creating sample credit card transactions
"""
...
try:
    from .data_models import Transaction, CreditCard, Merchant
...
class TransactionGenerator:
    ...
    def generate_user_spending_pattern(self, 
        ...
        preferred_categories = random.sample(list(MERCHANT_CATEGORIES.keys()), 
                                           random.randint(2, 4))
